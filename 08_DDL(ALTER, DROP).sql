...
ALTER TABLE DEPT_COPY DROP COLUMN LOCATION_ID; -- 테이블은 최소 하나 이상의 컬럼이 필요
...
-- 2_2) 제약조건 삭제 : DROP CONSTRAINT 제약조건명 ; NOT NULL -> 삭제 안됨
ALTER TABLE DEPT_TABLE
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C007141 TO DTABLE_ID_NN;
